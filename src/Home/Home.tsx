      ...
      >
        ...
        >
          ...
          <Grid
            ...
            gridTemplateRows={'72px repeat(5, 100px)'}
            gridTemplateAreas={`
        ...
        `}
          >
            ...
            <GridArea gridArea="thirteen">
              <Flex width="100%" height="100%">
                <Button disabled width="155px" hierarchy="primary">
                  Disabled
                </Button>
              </Flex>
            </GridArea>

            <GridArea gridArea="fourteen">
              <Flex width="100%" height="100%">
                <GhostButton disabled width="155px" hierarchy="primary">
                  Disabled
                </GhostButton>
              </Flex>
            </GridArea>

            <GridArea gridArea="fifteen">
              <Flex width="100%" height="100%">
                <TextButton disabled width="155px" hierarchy="primary">
                  Disabled
                </TextButton>
              </Flex>
            </GridArea>
